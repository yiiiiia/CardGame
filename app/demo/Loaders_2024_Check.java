...
public class Loaders_2024_Check {
	...
	/**
	 * This is a test of the loading and rendering for the 2024 unit set. It exists
	 * as a convenient way for Richard to check that he has not broken anything when
	 * he updated the template to add the new 2024 decks.
	 */
	public static void test(ActorRef out) {
		...
		for (Card card : cards) {
			...
			if (card.getIsCreature()) {
				...
				// playUnitAnimation [Move] and wait for a period until the animation does one
				// cycle
				try {
				...
				// playUnitAnimation [Attack] and wait for a period until the animation does one
				// cycle
				try {
				...
				// playUnitAnimation [Death] and wait for a period until the animation does one
				// cycle
				try {
