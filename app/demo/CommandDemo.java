...
public class CommandDemo {
	 ...
	 * 
	 * WARNING: This is a very long-running method, as it has a lot thread sleeps in
	 * it. The back-end will not respond to commands while this method is
	 * processing, e.g. if you refresh the game page or try to kill the server you
	 * will get a long delay before anything happens.
	 */
